...
// // // //   final Map<String, dynamic>? navData; // pass for edit
// // // //
...
// // // //     orderCtrl =
// // // //         TextEditingController(text: widget.navData?['order']?.toString() ?? '0');
// // // //     orgCtrl =
// // // //         TextEditingController(text: widget.navData?['organization'] ?? '');
// // // //
...
// // // //         // PUT
// // // //         res = await http.put(
// // // //           Uri.parse('$baseUrl/api/navigation/${widget.navData!['_id']}'),
// // // //           headers: {"Content-Type": "application/json"},
// // // //           body: jsonEncode(body),
// // // //         );
// // // //       }
...
// // // //     return Scaffold(
// // // //       appBar: AppBar(
// // // //         title: Text(widget.navData == null
// // // //             ? "Create Navigation"
// // // //             : "Edit Navigation"),
// // // //       ),
// // // //       body: Padding(
...
// // // //           child: ListView(
// // // //             children: [
// // // //               _input(labelCtrl, "Label"),
// // // //               _input(iconCtrl, "Icon (ex: wallet_check)"),
// // // //               _input(orderCtrl, "Order", number: true),
// // // //               _input(orgCtrl, "Organization ID"),
// // // //
// // // //               const SizedBox(height: 12),
// // // //
// // // //               DropdownButtonFormField<String>(
...
// // // //                 child: loading
// // // //                     ? const CircularProgressIndicator()
// // // //                     : Text(widget.navData == null ? "CREATE" : "UPDATE"),
// // // //               )
// // // //             ],
// // // //           ),
// // // //         ),
...
// //
// //   final String baseUrl = "http://YOUR_SERVER_IP:5000/api"; // 🔁 CHANGE
// //
// //   String? organizationId;
// //
// //   @override
...
// //
// //   Widget _buildMainUI() {
// //     /// YOUR UI — NOT MODIFIED
// //     return super.widget.build(context);
// //   }
// //
...
//       return Center(
//         child: Lottie.asset('assets/Animation - 1749442430422.json', height: 200),
//       );
//     }
//
//     return Column(
...
//             onSelected: (v) {
//               if (v == 'remove') {
//                 widget.onRemoveItem(widget.items.indexOf(item));
//               }
//             },
//           ),
//         );
...
//
//   Widget _renderMobileLayout() {
//     final previewItems = filteredItems.take(6).toList();
//
...
//                   left: 0,
//                   right: 0,
//                   child: _previewTitle(item['title']),
//                 ),
//               ],
//             ),
//           ),
...
//   }
//
//   Widget _previewTitle(String? title) {
//     return Container(
//       padding: const EdgeInsets.all(8),
...
//               InkWell(
//                 onTap: () => updateLayoutBackend(selectedLayout),
//                 child: Text("Apply",
//                     style: GoogleFonts.poppins(
//                         fontSize: 18,
//                         fontWeight: FontWeight.w600,
...
//     return InkWell(
//       onTap: () {
//         setState(() => selectedLayout = title.toLowerCase());
//       },
//       child: AnimatedContainer(
//         duration: const Duration(milliseconds: 200),
//         padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
...
class _CustomRightDrawerState extends State<CustomRightDrawer> {
  ...
  Future<void> _loadLists() async {
    setState(() => isLoading = true);
    try {
      final items = await ItemService.fetchItems(parentId: widget.parentId);
      setState(() {
        recentLists = items.where((i) => i.type == selected.name).map((i) =>
            ListModel(
              id: i.id,
              title: i.title,
              subtitle: i.subtitle,
  ...
  Future<void> _handleCreateNewList() async {
    ...
    try {
      final newItem = await ItemService.createItem(
        ...
        type: selected.name,
        url: selected.isLink ? newUrl : null,
        imageBytes: pickedImage,
      );
      ...
      children: [
        ...
        Center(
          child: ElevatedButton.icon(
            ...
            label: Text("Create ${selected.name.capitalize()}"),
  ...
  Widget _buildCreateForm() {
    return Column(
      ...
      children: [
        Row(
          children: [
            IconButton(icon: const Icon(Iconsax.arrow_left), onPressed: () => setState(() => showCreateForm = false)),
            Text("Create ${selected.name.capitalize()}",
                style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
          ],
        ),
  ...
  Widget _defaultFormUI() {
    return Column(
      children: [
        _input("Title", (v) => newTitle = v),
        _input("Subtitle", (v) => newSubtitle = v),

        if (selected.isLink)
          _input("URL", (v) => newUrl = v),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: pickedImage == null
                ...
                : ClipRRect(borderRadius: BorderRadius.circular(10), child: Image.memory(pickedImage!, fit: BoxFit.cover)),
          ),
        ),
  ...
  Widget _eventFormUI() {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: _datePicker("Start date", startDate, (v) => setState(() => startDate = v))),
            const SizedBox(width: 10),
            Expanded(child: _timePicker("Start time", startTime, (v) => setState(() => startTime = v))),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(child: _datePicker("End date", endDate, (v) => setState(() => endDate = v))),
            const SizedBox(width: 10),
            Expanded(child: _timePicker("End time", endTime, (v) => setState(() => endTime = v))),
          ],
        ),
  ...
  // ================= HELPERS =================
  Widget _section(String title) => Text(title, style: GoogleFonts.poppins(fontWeight: FontWeight.w600));
  ...
  Widget _datePicker(String label, DateTime? date, Function(DateTime) onPick) {
    return _picker(label, date == null ? "Select date" : "${date.day}/${date.month}/${date.year}", Icons.calendar_month, () async {
  ...
  Widget _timePicker(String label, TimeOfDay? time, Function(TimeOfDay) onPick) {
    return _picker(label, time == null ? "Select time" : time.format(context), Icons.access_time, () async {
