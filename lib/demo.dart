...
//     });
//
//     await Future.wait([_loadManualEvents(), _loadIcsSources()]);
//
//     if (mounted) {
//       setState(() {
//         isLoading = false;
...
//       manualEvents = allItems.where((e) => e.type == 'event').toList();
//     } catch (e) {
//       debugPrint('Load Manual Events Error: $e');
//     }
//   }
//
//   // =========================================================
...
//                     // =======================================
//                     if (dialogTab == 0 && urlController.text.isNotEmpty) {
//                       await IcsController.createIcsFromUrl(
//                         title: 'Calendar Sync',
//
//                         originalUrl: urlController.text.trim(),
//                       );
//                     }
//                     // =======================================
//                     // FILE IMPORT
//                     // =======================================
//                     else if (dialogTab == 1 && pickedFile != null) {
//                       await IcsController.createIcsFromFile(
...
//   Widget _buildBodyContent(bool isDesktop) {
//     if (selectedSource != null) {
//       return _buildModernYearlyCalendar(isDesktop);
//     }
//
//     return activeTab == 0
...
//
//             if (selectedSource != null)
//               _circularActionBtn(Iconsax.close_circle, Colors.redAccent, () {
//                 setState(() {
//                   selectedSource = null;
//                 });
//               })
...
//         return _buildEventCard(manualEvents[index]);
...
//     DateTime? date = DateTime.tryParse(item.startDateTime ?? "");
//
//     return Container(child: const SizedBox());
//   }
//
//   // =========================================================
//   // SYNCED SOURCES
...
//
//       delegate: SliverChildBuilderDelegate((context, index) {
//         return _buildSourceTile(syncedSources[index]);
...
//         children: [
//           Expanded(
//             child: _toggleItem("URL Link", current == 0, () {
//               onChange(0);
//             }),
//           ),
//
//           Expanded(
//             child: _toggleItem("Local File", current == 1, () {
//               onChange(1);
//             }),
//           ),
//         ],
...
//               fontWeight: FontWeight.bold,
//
//               color: s ? const Color(0xFF00C2D1) : Colors.grey,
//             ),
//           ),
//         ),
//       ),
