...
class _LibraryPageState extends State<LibraryPage> {
    ...
    return Row(
      ...
      children: [
        Column(
          ...
          children: [
            Text("Media Library",
                style: GoogleFonts.poppins(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.blueGrey.shade900)),
            Text("Manage your uploads and series collections",
  ...
  Widget _featureCard(String title, String desc, IconData icon, Color color, String btnText) {
    return Container(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
                backgroundColor: Colors.white24, foregroundColor: Colors.white, elevation: 0,
...
// ================= BALANCED UI COMPONENTS =================
                ...
                Expanded(
                  child: ClipRRect(
                    ...
                    child: series["thumbnail"] != null
                        ...
                        : Container(color: Colors.indigo.withOpacity(0.05), child: const Icon(Iconsax.folder_open, color: Colors.indigo, size: 20)),
                  ),
                ),
                Padding(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                            ...
                            style: GoogleFonts.poppins(fontWeight: FontWeight.w600, fontSize: 11, color: Colors.blueGrey.shade800)
                        ),
                      ),
                      ...
                      SizedBox(
                        ...
                        child: PopupMenuButton<String>(
                          ...
                          onSelected: (v) { if (v == "del") _deleteSeries(series); },
  ...
  PopupMenuItem<String> _buildPopupItem(String value, IconData icon, String label) {
    return PopupMenuItem(
      value: value,
      child: Row(children: [Icon(icon, size: 18, color: Colors.indigo), const SizedBox(width: 10), Text(label, style: GoogleFonts.poppins(fontSize: 13))]),
    );
  }
}