...
//         context,
//       ).showSnackBar(const SnackBar(content: Text("Failed to delete series")));
//     }
//   }
//
...
//                           : ListView.builder(
//                               itemCount: _mediaItems.length > 5
//                                   ? 5
//                                   : _mediaItems.length,
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 16,
                children: _mediaSeries.take(5).map((series) {
                  final createdDate = series["createdAt"] != null && series["createdAt"] is String
