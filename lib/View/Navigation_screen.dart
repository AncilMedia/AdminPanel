...
//   }
//
//   Future<void> toggleDefault(String navId) async {
//     if (selectedOrgId == null) return;
//
//     try {
//       final res = await http.put(
//         Uri.parse("$navApiUrl/default/$navId/$selectedOrgId"),
//       );
//
//       if (res.statusCode == 200) {
//         await fetchNavsForOrg();
//       } else {
//         debugPrint("Default API failed: ${res.body}");
//         showSnack("Failed to set default");
//       }
//     } catch (e) {
//       debugPrint("Default error: $e");
//       showSnack("Default error: $e");
//     }
//   }
//
//   Future<void> checkUserRole() async {
...
//         const SizedBox(height: 12),
//         ...items.map((nav) {
//           bool isDefault = nav['isDefault'] ?? false;
//
//           return Container(
//             margin: const EdgeInsets.only(bottom: 8),
//             decoration: BoxDecoration(
...
//               leading: CircleAvatar(
//                 backgroundColor:
//                 isAssigned ? primaryIndigo.withOpacity(0.1) : slate50,
//                 child: Icon(Iconsax.link,
//                     color: isAssigned ? primaryIndigo : slate500, size: 18),
//               ),
//               title: Text(
//                 nav['label'] ?? '',
//                 style: GoogleFonts.plusJakartaSans(
...
//                 children: [
//                   // Tooltip or Label helps clarify which switch is which
//                   const Text("Assign ", style: TextStyle(fontSize: 10)),
//                   Switch.adaptive(
//                     activeColor: primaryIndigo,
//                     value: isAssigned,
//                     onChanged: (_) => toggleNav(nav['_id'].toString()),
...
//                     // Disable default switch if the item isn't assigned
//                     value: isDefault,
//                     onChanged: isAssigned
//                         ? (_) => toggleDefault(nav['_id'].toString())
//                         : null,
//                   ),
//                 ],
//               )
