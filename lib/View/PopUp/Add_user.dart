...
class _AddUserDialogState extends State<AddUserDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      backgroundColor: Colors.transparent,
      // Adjusting inset padding based on screen size for better mobile fit
      insetPadding: EdgeInsets.symmetric(
        horizontal: screenSize.width > 600 ? screenSize.width * 0.1 : 16,
        vertical: 24,
      ),
      child: LayoutBuilder(
        builder: (context, constraints) {
          return Container(
            // Responsive width: Use 450 max, but shrink to fit mobile
            constraints: const BoxConstraints(maxWidth: 480),
            padding: EdgeInsets.all(screenSize.width > 600 ? 32 : 20),
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(28),
              boxShadow: [
            ...
            child: SingleChildScrollView(
              // Physics ensure bounce feel on mobile
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Action Buttons Row - Adapts padding for mobile
                    _buildActionButtons(authState, screenSize.width > 400),
                  ],
                ),
              ),
            ),
  ...
  Widget _modernTextField({
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          prefixIcon: Icon(icon, size: 18, color: Colors.teal.shade400),
          suffixIcon: suffix,
          filled: true,
          fillColor: Colors.grey.shade50,
          border: OutlineInputBorder(
  ...
  Widget _buildActionButtons(AuthState authState, bool isWide) {
    // On extremely narrow screens, we could stack these,
    // but for 400px+ a Row usually looks better.
    return Row(
      children: [
        Expanded(
          child: OutlinedButton(
            ...
            child: Text(
                "Cancel",
                style: GoogleFonts.poppins(color: Colors.blueGrey, fontWeight: FontWeight.w600, fontSize: 14)
            ),
          ),
        ),
        const SizedBox(width: 12),
