...
//     ) async {
//   String? selectedSeries;
//   String mediaSource = "file"; // Default
//   bool isUploading = false;
//
//   final titleController = TextEditingController();
//   final descriptionController = TextEditingController();
...
//                           DropdownMenuItem(value: "youtube", child: Text("YouTube", style: TextStyle(fontSize: 13))),
//                           DropdownMenuItem(value: "vimeo", child: Text("Vimeo", style: TextStyle(fontSize: 13))),
//                           DropdownMenuItem(value: "drive", child: Text("Google Drive", style: TextStyle(fontSize: 13))), // Added Drive
//                         ],
//                         onChanged: (val) {
//                           setState(() {
//                             mediaSource = val!;
//                             // Clear inputs when source changes to prevent data mismatch
//                             if (mediaSource != "file") {
//                               pickedFile = null;
//                               webFile = null;
//                             }
...
//                 _buildLabel("Media Content"),
//
//                 // Logic to show Picker or URL Input
//                 if (mediaSource == "file")
//                   _modernPicker(
//                     label: pickedFile?.path.split('/').last ?? webFile?.name ?? "Pick Video File",
//                     icon: Iconsax.video_add,
...
//                   _modernInput(
//                       mediaUrlController,
//                       "Paste $mediaSource URL",
//                       mediaSource == "drive" ? Iconsax.cloud_add : Iconsax.link
//                   ),
//
//                 const SizedBox(height: 16),
//                 _buildLabel("Thumbnail"),
...
//                       }
//
//                       // Validate Google Drive URLs specifically
//                       if (mediaSource == "drive" && !mediaUrlController.text.contains("drive.google.com")) {
//                         showCustomSnackBar(context, "Invalid Google Drive link", false);
//                         return;
//                       }
//
//                       setState(() => isUploading = true);
  ...
  return showDialog(
    ...
    builder: (context) => StatefulBuilder(
      builder: (context, setState) {
        ...
        return Dialog(
          backgroundColor: Colors.transparent,
          // Ensuring the dialog shifts up when keyboard appears
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              // Allow content to scroll if it exceeds height (especially on mobile)
              child: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                    ...
                    child: ElevatedButton(
                      ...
                      child: isUploading
                        ...
                        child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2),
                          ...
                          : Text(
                        "Create Media Item",
                        style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.white, fontSize: isMobile ? 14 : 16),
                      ),
                    ),
                  ),
                ],
...
// --- HELPER UI WIDGETS remain largely the same, just made them slightly more flexible ---
