...
//   //     final Map<String, dynamic> jsonData = json.decode(responseBody);
//   //
//   //     // ✅ FIX: use 'item' instead of 'data'
//   //     return ItemModel.fromJson(jsonData['item']);
//   //   } else {
//   //     final errorBody = await response.stream.bytesToString();
//   //     throw Exception('Failed to create item: ${response.statusCode} $errorBody');
//   //   }
...
//     String? subtitle,
//     String? url,
//     required String type, // <-- MUST be 'link', 'list', or 'event'
//     String? parentId,
//     Uint8List? imageBytes,
//     String? imageUrl,
//   }) async {
...
//     // ✅ Required fields
//     request.fields['title'] = title;
//     request.fields['type'] = type.trim(); // <-- Ensure no trailing space
//
//     // ✅ Optional fields
...
//     print('📤 Sending item with fields: ${request.fields}');
//
//     try {
//       final response = await request.send();
//
